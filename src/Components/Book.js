...
import { setBookToEdit } from "../redux/Books/actions";
import deleteBookRequest from "../redux/Books/thunk/deleteBook";
      ...
      <div className="book-card">
        ...
        <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
          <div className="flex items-center justify-between">
            <span
              className={`${book.featured && "badge-success lws-Badge"}`}
            >
            ...
            <div className="text-gray-500 space-x-2">
              ...
              <button className="lws-delete" onClick={handleRemove}>
                <svg
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
          ...
          <div className="space-y-2 mt-4 h-full">
            ...
            <p className="lws-price">GBP {book.price}</p>
          </div>
        </div>
      </div>
    </>
